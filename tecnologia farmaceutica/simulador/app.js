...
(function () {
  ...
  const STORAGE_STATS = "tecnoFarmaP1_stats_v1";
  const STORAGE_HISTORY = "tecnoFarmaP1_history_v1";
  const STORAGE_GAME = "tecnoFarmaP1_game_v1";
  const STORAGE_SRS = "tecnoFarmaP1_srs_v1";
  ...
  const LEVELS = [
    { min: 0,    title: "Aprendiz de Mortero",              icon: "🌱" },
    { min: 100,  title: "Técnico/a de Botica",               icon: "📘" },
    { min: 250,  title: "Pulverizador/a Experto/a",          icon: "🔨" },
    { min: 500,  title: "Granulador/a Certificado/a",        icon: "🧪" },
    { min: 800,  title: "Especialista en Preformulación",    icon: "🧠" },
    { min: 1200, title: "Maestro/a Galénico/a",               icon: "💪" },
    { min: 1700, title: "Doctor/a en Tecnología Farmacéutica",icon: "🎓" },
    { min: 2300, title: "Catedrático/a de Farmacia Galénica",icon: "👑" },
  ];
