...
(function () {
  ...
  const STORAGE_STATS = "bqClinica_stats_v1";
  const STORAGE_HISTORY = "bqClinica_history_v1";
  const STORAGE_GAME = "bqClinica_game_v1";
  const STORAGE_SRS = "bqClinica_srs_v1";
  ...
  const LEVELS = [
    { min: 0,    title: "Estudiante en prácticas",          icon: "🌱" },
    { min: 100,  title: "Aprendiz de fase preanalítica",     icon: "🧪" },
    { min: 250,  title: "Técnico/a de laboratorio clínico",  icon: "🔬" },
    { min: 500,  title: "Analista de bioquímica clínica",    icon: "🩸" },
    { min: 800,  title: "Especialista en hematología",       icon: "🧬" },
    { min: 1200, title: "Interno/a de análisis clínicos",    icon: "💉" },
    { min: 1700, title: "Facultativo/a de laboratorio",      icon: "🎓" },
    { min: 2300, title: "Doctor/a en Bioquímica Clínica",    icon: "👑" },
  ];
