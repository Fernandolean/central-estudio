...
(function () {
  ...
  const STORAGE_STATS = "metodInvSim_stats_v1";
  const STORAGE_HISTORY = "metodInvSim_history_v1";
  const STORAGE_GAME = "metodInvSim_game_v1";
  const STORAGE_SRS = "metodInvSim_srs_v1";
  ...
  const LEVELS = [
    { min: 0,    title: "Observador/a novato/a",              icon: "🔎" },
    { min: 100,  title: "Recopilador/a de datos",              icon: "📝" },
    { min: 250,  title: "Analista de datos",                   icon: "📊" },
    { min: 500,  title: "Investigador/a en formación",         icon: "🧪" },
    { min: 800,  title: "Especialista en bioestadística",      icon: "📈" },
    { min: 1200, title: "Revisor/a por pares",                 icon: "🧐" },
    { min: 1700, title: "Metodólogo/a experto/a",               icon: "🧭" },
    { min: 2300, title: "Doctor/a en Metodología de la Investigación", icon: "🎓" },
  ];
