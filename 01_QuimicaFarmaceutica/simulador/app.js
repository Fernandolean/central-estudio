...
(function () {
  ...
  const STORAGE_STATS = "quimicaFarmaceutica_stats_v1";
  const STORAGE_HISTORY = "quimicaFarmaceutica_history_v1";
  const STORAGE_GAME = "quimicaFarmaceutica_game_v1";
  const STORAGE_SRS = "quimicaFarmaceutica_srs_v1";
  ...
  const LEVELS = [
    { min: 0,    title: "Novato/a en Química Orgánica",          icon: "🧪" },
    { min: 100,  title: "Cazador/a de pKa",                      icon: "🔬" },
    { min: 250,  title: "Especiador/a de Fármacos",              icon: "⚗️" },
    { min: 500,  title: "Piloto de LADME",                       icon: "💊" },
    { min: 800,  title: "Cazador/a de Farmacóforos",             icon: "🎯" },
    { min: 1200, title: "Maestro/a del Reconocimiento Molecular", icon: "🧬" },
    { min: 1700, title: "Bioquímico/a del Metabolismo",          icon: "⚛️" },
    { min: 2300, title: "Doctor/a en Química Farmacéutica",      icon: "👑" },
  ];
